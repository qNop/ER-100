            ...
            Item{
                ...
                WeldData{
                    ...
                    onCurrentRowChanged: {
                        ...
                        console.log("app.weldTableIndex is "+app.weldTableIndex);
                    }
                    model: weldTable
    ...
    Connections{
        ...
        onWeldRulesChanged:{
            ...
            if((typeof(value)==="object")&&(value.length===21)&&(value[0]==="Successed")){
                ...
                console.log("weld guifan ok")
                //选中焊接规范表格的第一行数据
                if(weldTable.count){
                    console.log("changeWeldIndex")
                    //先改变 Table 然后在改变App
                    changeWeldIndex(0);
                    //下发第一条规范
