...
//    }
    ...
    function openDatabase() {
        ...
        dataBase.transaction( function(tx) {
            ...
            /********************************************平焊单边V型坡口T接头*********************************************/
            tx.executeSql('CREATE TABLE IF NOT EXISTS FlatWeldSingleBevelGrooveT(id INT NOT NULL PRIMARY KEY,value TEXT)');
            ...
            tx.executeSql('CREATE TABLE IF NOT EXISTS flatweldsinglebevelgroove(id INT NOT NULL PRIMARY KEY,value TEXT)');
            ...
            tx.executeSql('CREATE TABLE IF NOT EXISTS flatweldvgroove(id INT NOT NULL PRIMARY KEY,value TEXT)');
            ...
            tx.executeSql('CREATE TABLE IF NOT EXISTS horizontalweldsinglebevelgroovet(id INT NOT NULL PRIMARY KEY,value TEXT)');
            ...
            tx.executeSql('CREATE TABLE IF NOT EXISTS horizontalweldsinglebevelgroove(id INT NOT NULL PRIMARY KEY,value TEXT)');
            ...
            tx.executeSql('CREATE TABLE IF NOT EXISTS  verticalWeldSingleBevelGrooveT(id INT NOT NULL PRIMARY KEY,value TEXT)');
            ...
            tx.executeSql('CREATE TABLE IF NOT EXISTS  verticalweldsinglebevelgroove(id INT NOT NULL PRIMARY KEY,value TEXT)');
            ...
            tx.executeSql('CREATE TABLE IF NOT EXISTS  verticalweldvgroove(id INT NOT NULL PRIMARY KEY,value TEXT)');
            ...
            tx.executeSql('CREATE TABLE IF NOT EXISTS  flatfillet(id INT NOT NULL PRIMARY KEY,value TEXT)');
